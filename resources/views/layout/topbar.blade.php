                                ...
                                <div class="message-wrap">
                                    ...
                                    <ul class="clearfix">
                                        <li class="clearfix">
                                            ...
                                            <clearfixclearfix/a><a href="#" class="message-intro"><span class="message-meta">Adellecharles </span>Nunc aliquam dolor... <span class="message-time">today at 10:20 pm</span></a>
                                        </li>
                                        <li class="clearfix">
            ...
            <div class="col-md-6 responsive-fix">
                <div class="top-aside-right">
                            ...
                            <li class="dropdown">
                                <a data-toggle="dropdown" href="#" class="clearfix dropdown-toggle waves-effect waves-block waves-classic">
                                    ...
                                    @if(isset(Auth::user()->avatar) && Auth::user()->avatar!=null)
                                        ...
                                        {{--<span class="user-thumb"><img src="http://img3.imgtn.bdimg.com/it/u=3693293767,1501712154&fm=21&gp=0.jpg" alt="image"></span>--}}
                    ...
                    <div class="col-md-6 responsive-fix top-mid" style="float: right;padding-right: 47px;">
                        <div class="notification-nav">
                          {{--  <ul class="clearfix">
                                <li class="" style="float: right"><a href=""  class=""><i class="fa fa-shopping-cart"></i><span class="alert-bubble car-num"></span></a>
